    ...
    <div id='about'>
        <section className='grid lg:grid-cols-2 md:grid-cols-2 sm:grid-cols-1 mt-20 mb-10 gap:10 mx-5'>
            <div className='text-white font-[Quicksand]  lg:px-10 lg:py-10' data-aos="fade-up">
                ...
                <span>
                    <Link  to='portfolio' className='border p-2 rounded bg-pink-700 font-bold  hover:bg-white hover:text-pink-700'>See my work</Link>
            ...
            <div className='lg:ms-10 sm:py-10 px-10' data-aos="fade-up">
